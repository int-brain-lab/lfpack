...
| saturation_intervals | np.ndarray or None | ``(n_intervals, 2)`` int64 array of ``[start_sample, stop_sample]`` saturated spans at the raw LFP rate.  Written once at ``/<recording>/saturation`` (scale ``00`` only).  Default None (no saturation table).                                                                                                                                                                                                                  | `None`              |
| saturation_attrs     | dict or None       | Attributes attached to the saturation dataset (fs, ns_total, saturated_fraction, detection parameters, whether muting was applied).  Default None.                                                                                                                                                                                                                                                                               | `None`              |